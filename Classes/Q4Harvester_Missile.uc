class Q4Harvester_Missile extends Quake4Projectile placeable;
...
{
    if ( (Other != instigator) && Q4Harvester_Missile(Other) == None && (!Other.IsA('Projectile') || Other.bProjTarget) )
    {
...
defaultproperties
{
     ...
     TrailClass=Class'tk_Quake4Monstersv1.Q4Harvester_Missile_Trail'
     ExplosionClass=Class'tk_Quake4Monstersv1.Q4Harvester_Missile_Explode'
     bSeeking=True
     Speed=600.000000
     MaxSpeed=1200.000000
     Damage=500.000000
     MyDamageType=Class'tk_Quake4Monstersv1.DamType_Q4Harvester'
